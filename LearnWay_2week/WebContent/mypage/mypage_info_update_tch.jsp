	             ...
	             <div class="home"><img src="../resources/image/login_logo.PNG"/></div> 
					<div class="form-group">
		             ...
		             <div class="form-group">
		                ...
		                <input class="btn" type="button" value="취소" onclick="location.href='../index.jsp?id=<%=member_id%>'">
	                 </div>
	            </form>
	            </div>
	         </div>
